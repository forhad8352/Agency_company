...
import Sayy from "../assets/say.png";
import { FaQuoteRight } from "react-icons/fa";
const Testimonial = () => {
  return (
    <section className='bg-[url("/src/assets/World.png")] bg-no-repeat bg-cover bg-center h-[1000px] relative'>
      <div className="text-center pt-[100px]">
        <h6 className="font-dmSans font-medium text-[20px] text-transparent bg-gradient-to-r from-grad to-ent bg-clip-text ">
          Testimonial
        </h6>
        <h3 className="font-nuni font-bold text-[46px] text-main">
          What Our Client Say
        </h3>
      </div>
      <div className="group absolute top-[33.2%] left-[18%]">
        <div className="p-[3px] bg-gradient-to-r from-startC to-endC rounded-full h-[60px] w-[60px] flex items-center justify-center cursor-pointer">
          <div className="relative">
            <img src={Sayy} alt="" className="h-[54px] w-[54px] rounded-full" />
          </div>
        </div>
        <div className="absolute top-[50%] left-[-50%] translate-y-[-50%] translate-x-[21%] p-[2px] hidden group-hover:block bg-gradient-to-r from-startC to-endC rounded-3xl z-50">
          <div className="bg-white w-[420px] px-[23px] pt-[23px] pb-[16px] rounded-3xl">
            ...
            <p className="font-dmSans font-normal text-[16px] text-ptag leading-[26px] pt-[30px]">
              There are many variations of passages of rem Ipsum available, but
              the majoritsy have suffer eration in some form, by injecteld
              humour, or mised words which don&#39;t look even.
            </p>
          </div>
        </div>
      </div>
