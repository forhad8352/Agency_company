...
import Faqq from "../assets/faqq.png";
import Container from "./Container";
const Faq = () => {
  let [show, setShow] = useState(false);
  let [showw, setShoww] = useState(false);
  let [showww, setShowww] = useState(false);
  let [showwwww, setShowwwww] = useState(false);
  return (
    <div className="py-[114px]">
      <Container>
        <div className="flex justify-between">
          <div className="w-[50%]">
            <h4 className="font-medium font-dm text-[20px] text-orange-400">
              Common Questions
            </h4>
            <h3 className="font-nunito text-[46px] font-bold text-primary">
              Frequently Asked Questions
            </h3>
            <div className="flex pt-[47px]">
              <div className="">
                <div className="group">
                  <div className="  flex items-center py-[11px] px-[30px] bg-[#F4F4FF] rounded-[50px] group-hover:bg-[#3661FC] duration-300 ease-in-out ">
                    <span>
                      <svg
                        className=" fill-[#3661FC] group-hover:fill-white"
                        width="38"
                        height="38"
                        viewBox="0 0 38 38"
                        fill="none"
                      ...
                      >
                        ...
                        />
                        <path
                          d="M12.8121 24.9256C12.8121 24.6117 12.8121 24.2978 12.8121 23.9838C12.8121 22.3201 13.2042 21.8649 14.8667 21.6295C16.6703 21.3784 17.4859 19.4635 16.435 18.0352C15.3842 16.6226 13.314 16.9208 12.4828 18.616C12.0123 19.6048 11.3065 20.06 10.4753 19.9187C9.25193 19.7147 8.64027 18.6003 9.06373 17.376C9.87928 15.006 12.4828 13.2952 15.0078 13.4835C17.7211 13.6876 19.9796 15.6966 20.4344 18.3334C20.8892 20.9703 19.6345 23.4973 17.2035 24.7058C16.6546 24.9727 16.435 25.3023 16.4664 25.9144C16.4978 26.762 16.3096 27.531 15.494 28.0019C14.3334 28.6454 12.9533 27.9234 12.8278 26.5893C12.7808 26.0243 12.8278 25.4592 12.8121 24.9256Z"
                          fill=""
                        />
                        <path
                          d="M14.5843 28.9908C15.6351 28.9751 16.4977 29.8384 16.482 30.8586C16.4663 31.8631 15.6351 32.6793 14.6157 32.6793C13.6119 32.6793 12.7964 31.8631 12.7964 30.8429C12.7807 29.8227 13.5649 29.0065 14.5843 28.9908Z"
                          fill=""
                        />
                        <path
                          d="M2.99403 19.9659C3.60569 17.5017 4.8447 15.3985 6.7581 13.6876C6.99336 13.4836 7.27566 13.3894 7.5266 13.6563C7.80891 13.9545 7.68344 14.237 7.44818 14.4724C5.77003 16.042 4.62513 17.9411 4.04483 20.1699C3.96641 20.4838 3.77821 20.7663 3.37043 20.6565C3.04108 20.5623 2.94697 20.2955 2.99403 19.9659Z"
                          fill=""
                        />
                      </svg>
                    </span>

                    <h4 className="font-dm font-medium text-[20px] text-primary pl-[15px] group-hover:text-white">
                      General Questions
                    </h4>
                  </div>
                </div>
                  ...
                  <div className="  flex items-center py-[11px] px-[30px] bg-[#F4F4FF] rounded-[50px] group-hover:bg-[#3661FC] duration-300 ease-in-out ">
                    <span>
                      ...
                      >
                        ...
                        />
                        <path
                          d="M14.8357 15.3771C15.4725 15.3475 16.0796 15.4955 16.5978 15.8654C16.9828 16.1466 17.279 16.0874 17.664 15.8506C19.1299 14.9776 20.9068 15.318 21.9285 16.6053C22.965 17.9222 22.8762 19.683 21.6768 20.9111C20.5958 22.0209 19.5001 23.1158 18.3747 24.2108C17.5603 24.995 16.6867 25.0098 15.8871 24.2404C14.7321 23.1306 13.5919 22.0061 12.4962 20.8371C11.5485 19.8309 11.3264 18.6176 11.8742 17.3451C12.4221 16.0726 13.4438 15.4215 14.8357 15.3771Z"
                          fill=""
                        />
                      </svg>
                    </span>
                  ...
                  <div className="  flex items-center py-[11px] px-[30px] bg-[#F4F4FF] rounded-[50px] group-hover:bg-[#3661FC] duration-300 ease-in-out ">
                    <span>
                      ...
                      >
                        ...
                        />
                        <path
                          d="M21.3029 14.8788C23.4178 14.8788 25.5328 14.8788 27.6478 14.8788C28.6387 14.8788 29.112 15.2696 29.1268 16.0511C29.1416 16.8326 28.6387 17.3285 27.7218 17.3285C23.4178 17.3436 19.1139 17.3436 14.81 17.3285C13.8782 17.3285 13.3606 16.8326 13.3606 16.0811C13.3606 15.2996 13.893 14.8788 14.884 14.8638C17.0137 14.8788 19.1583 14.8788 21.3029 14.8788Z"
                          fill=""
                        />
                        <path
                          d="M21.2585 12.5793C19.1139 12.5793 16.9694 12.5793 14.8248 12.5793C13.8782 12.5793 13.3606 12.1435 13.3606 11.377C13.3606 10.6255 13.8782 10.1296 14.81 10.1145C19.0991 10.0995 23.3883 10.0995 27.6774 10.1145C27.8253 10.1145 27.9732 10.1446 28.1211 10.1747C28.831 10.34 29.2008 10.8359 29.1268 11.5122C29.0676 12.1585 28.6387 12.5643 27.914 12.5643C25.6955 12.5943 23.477 12.5793 21.2585 12.5793Z"
                          fill="#"
                        />
                        <path
                          d="M18.6259 22.0327C17.3687 22.0327 16.1115 22.0477 14.8692 22.0327C13.893 22.0177 13.3606 21.5668 13.3606 20.7853C13.3606 20.0338 13.893 19.5679 14.8248 19.5529C17.4131 19.5379 19.9865 19.5379 22.5748 19.5529C23.4474 19.5529 23.9503 20.0188 23.9651 20.7703C23.9799 21.5217 23.477 22.0177 22.6192 22.0177C21.2733 22.0477 19.9422 22.0327 18.6259 22.0327Z"
                          fill=""
                        />
                      </svg>
                    </span>
          ...
          <div className="w-[50%]">
            <div className="py-[23px] px-[40px] bg-[#FFFFFF] drop-shadow-2xl rounded-[50px]">
              <div
                onClick={() => setShow(!show)}
                className="flex justify-between items-center cursor-pointer group"
              >
                <div className="">
                  <h4 className="text-[25px] font-nunito font-bold text-primary group-hover:text-[#3661FC]">
                ...
                <div className="">
                  {show == true ? (
                    <svg
                      className=" fill-[#1A1A1A] group-hover:fill-[#3661FC]"
                      width="23"
                      height="3"
                      viewBox="0 0 23 3"
                      fill="none"
                    ...
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <rect x="10" width="3" height="23" rx="1.5" fill="" />
                      <rect
                        x="23"
                        y="10"
                        width="3"
              ...
              {show && (
                <div className="py-[20px] ">
                  <div className="border-t-[1px] border-[#D7DFFE] pt-3">
                    <span className="text-[16px] text-grayy font-dm font-normal ">
            ...
            <div className="py-[23px] px-[40px] bg-[#FFFFFF] drop-shadow-2xl rounded-[50px] my-[30px]">
              <div
            ...
            <div className="py-[23px] px-[40px] bg-[#FFFFFF] drop-shadow-2xl rounded-[50px] mt-[30px]">
              <div
                onClick={() => setShowwwww(!showwwww)}
                className="flex justify-between items-center cursor-pointer group"
              >
                <div className="">
                  <h4 className="text-[25px] font-nunito font-bold text-primary group-hover:text-[#3661FC]">
